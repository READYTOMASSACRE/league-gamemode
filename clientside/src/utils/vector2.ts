 ...
 */
class Vector2 implements SHARED.TYPES.Vector2 {
  ...
  /**
   * Normalize Vector3Mp to Vector2
   * @param {Vector3Mp} vector 
   */
  static normalizeVector3Mp(vector?: Vector3Mp) : Vector2 {
    return vector && new Vector2([vector.x, vector.y]) || new Vector2()
  }
